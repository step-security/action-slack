...
\${process.env.AS_JOB} (\${process.env.AS_COMMIT}) of \${process.env.AS_REPO}@master by \${process.env.AS_AUTHOR} succeeded in \${process.env.AS_TOOK}\`
        ...
        text: `<https://github.com/step-security/action-slack/commit/b24f03a32e093fe8d55e23cfd0bb314069633b2f/checks|PR Checks>
<https://github.com/step-security/action-slack/runs/762195612|notification> (<https://github.com/step-security/action-slack/commit/b24f03a32e093fe8d55e23cfd0bb314069633b2f|b24f03a3>) of <https://github.com/step-security/action-slack|step-security/action-slack>@master by StepSecurity <maintained-actions-dev@stepsecurity.io> succeeded in 1 hour 1 min 1 sec`,
      });
    });
  });

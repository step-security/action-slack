...
beforeAll(() => {
  ...
  setupMockJobs(process.env.GITHUB_RUN_ID as string, 'actions.custom-job-name.jobs');
});
          ...
          fields: [
            {
              ...
              title: 'job',
              value:
                '<https://github.com/step-security/action-slack/runs/762195612|Custom Job (ubuntu-18.04)>',
            },

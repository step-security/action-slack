...
export const repo = (): Field => {
  return {
    ...
    title: 'repo',
    value:
      '<https://github.com/step-security/action-slack|step-security/action-slack>',
  };
};
...
export const commit = (): Field => {
  return {
    short: true,
    title: 'commit',
    value: `<https://github.com/step-security/action-slack/commit/${
...
export const author = (): Field => {
  return {
    short: true,
    title: 'author',
    value: 'StepSecurity <maintained-actions-dev@stepsecurity.io>',
  };
};
...
export const workflowRun = (): Field => {
  return {
    short: true,
    title: 'workflowRun',
    value: `<https://github.com/step-security/action-slack/actions/runs/762195612|${
...
export const job = (): Field => {
  return {
    short: true,
    title: 'job',
    value: `<https://github.com/step-security/action-slack/runs/762195612|${process.env.GITHUB_JOB}>`,
  };
};
...
export const pullRequest = (): Field => {
  ...
  if (context.eventName.startsWith('pull_request')) {
    value =
      '<https://github.com/step-security/action-slack/pull/123|Add pullRequest field &amp; escaping &lt;, &gt; #123>';
  } else {
    value = 'n/a';
  }
  return {
